...
namespace AnomalyDetectionCapabilitySample
{
    /// <summary>
    ...
    /// </summary>
    public class SampleAnomalyDetectionCapability : ICapability, IDisposable
    {
        ...
        public string Publisher => "Takeshi Katano";
        ...
        public CapabilityInformation GetCapabilityInformation()
        {
            ...
            return new CapabilityInformation(CapabilityPredictionType.Forecasting, new List<DataSource> { wellKnownSeriesVolume, perfCounter, etwSource }, "Sample System Insights capability that analyzes data from a well-known series, performance counters, and an ETW event.");
        }
