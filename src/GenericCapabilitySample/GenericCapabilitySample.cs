...
namespace GenericCapabilitySample
{
    /// <summary>
    ...
    /// </summary>
    public class SampleGenericCapability : ICapability, IDisposable
    {
        ...
        public CapabilityInformation GetCapabilityInformation()
        {
            ...
            return new CapabilityInformation(CapabilityPredictionType.Generic, new List<DataSource> { wellKnownSeriesVolume, perfCounter, etwSource }, "Sample System Insights capability that analyzes data from a well-known series, performance counters, and an ETW event.");
        }
